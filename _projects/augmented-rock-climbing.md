...
- Implemented a real-time pose estimation model to identify the locations of children's hands and feet.
- Utilized a real-time multi-object tracker (MOT) to track children across camera frames.
- Optimized pose estimation model to reduce inference time and model size to be deployed on general-purpose computer systems.
- Integrated motion tranking with Unity
