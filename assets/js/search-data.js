...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "my projects",
          description: "in real-world products",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-assr-as-a-biomarker",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/hasanghaffari93", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ghaffarisaravi", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
